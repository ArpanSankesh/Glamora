...
const Orders = () => {
  ...
  useEffect(() => {
    ...
    // Order by createdAt desc if index exists; otherwise you can drop orderBy
  ...
  const OrderCard = ({ order, muted = false, isCancelled = false }) => {
    ...
    return (
      <div
        className={`max-w-7xl mx-auto rounded-md border ${
          muted || isCancelled ? "bg-gray-50" : "bg-white"
        } ${
        ...
        <div className="flex flex-col gap-3 p-5">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="px-2 py-1 rounded bg-gray-100 text-xs">{order.userId.substring(0, 8)}...</span>
              <svg 
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-sm">
            <div>
              <span className="font-semibold">{order.customerName}</span> - {order.phone}
            </div>
            <div className="flex items-center gap-3">
              <span>Service: {order.date} at {order.time}</span>
        ...
        {isExpanded && (
          <div className="px-5 pb-5 space-y-4" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="bg-gray-50 rounded p-3 text-sm">
              <p><strong>Full Order ID:</strong> {order.id}</p>
              <p><strong>Full Customer ID:</strong> {order.userId}</p>
            </div>
