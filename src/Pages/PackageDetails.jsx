        ...
        <div className="p-6 max-w-4xl mx-auto py-30">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                {packageData.services.map((service) => (
                    <div
                        key={service.id}
                        className={`flex items-center gap-4 p-4 border rounded-lg cursor-pointer transition ${selectedServices.includes(service.id)
            ...
            <button
                onClick={handleCart}
                className={`mt-6 px-6 py-2 rounded-lg ${selectedServices.length !== maxServices
